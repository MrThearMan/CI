...
jobs:
  test:
    uses: MrThearMan/CI/.github/workflows/test.yml@v0.3.2
```
...
jobs:
  test:
    uses: MrThearMan/CI/.github/workflows/docs.yml@v0.3.2
```
...
jobs:
  test:
    uses: MrThearMan/CI/.github/workflows/release.yml@v0.3.2
    secrets:
