...
jobs:
  test:
    uses: MrThearMan/CI/.github/workflows/test.yml@v0.4.10
```
...
jobs:
  test:
    uses: MrThearMan/CI/.github/workflows/docs.yml@v0.4.10
```
...
jobs:
  test:
    uses: MrThearMan/CI/.github/workflows/release.yml@v0.4.10
    secrets:
...
jobs:
  approve:
    permissions:
      pull-requests: write
      contents: write
    uses: MrThearMan/CI/.github/workflows/approve.yml@v0.4.10
```
...
jobs:
  <foo>:
    steps:
      - ...
      - uses: MrThearMan/CI/.github/actions/poetry@v0.4.10
        with:
          os: "ubuntu-latest"
          poetry-version: "1.7.1"
```
...
jobs:
  <foo>:
    steps:
      - uses: MrThearMan/CI/.github/actions/get-changed-filetypes@v0.4.10
        id: changed
        with:
          filetypes: "py|yaml"
